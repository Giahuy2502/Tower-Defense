namespace _Asset.Scripts.MyAsset
{
    ...
    public enum EventName{UpdateGoldTxt,UpdateLivesTxt,SelectTower,WinGame,LoseGame,StartGame,EndGame,UpdateWaveProcessTxt,RestartGame,UpdateGemText,NextLevel}
